...
var listing, listing2, id, latitude, longitude;
...
describe('Listing Schema Unit Tests', function() {
  ...
  describe('Saving to database', function() {
    ...
    //it('saves properly when all listings provided', function(done){
      //new Listing(listing, listing2).save(function(err, listing, listing2){
        //should.not.exist(err);
      //  id = listing._id;
      //  id = listing2._id;
        //done();
